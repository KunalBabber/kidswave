...
import ReportVideoModal from "../component/ReportVideoModal";
  ...
  useEffect(() => {
    ...
    if (currentVideo) {
      ...
      if (userData?.isChildProfile) {
        if (!currentVideo.isApproved || currentVideo.isBlocked || (currentVideo.ageLimit > userData.age)) {
          setIsAllowed(false);
          showCustomAlert("This video is not appropriate for your age profile.");
          navigate("/");
          return;
        }
      }
    ...
    <button onClick={handleFullScreen}><FaExpand /></button>
        ...
        <div className="flex flex-wrap items-center justify-between">
          ...
          <div className="flex items-center gap-6 mt-3">
            ...
            <IconButton icon={FaFlag} label="Report" onClick={() => setShowReportModal(true)} />
          </div>
        </div>
