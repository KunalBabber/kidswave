...
/>
          ...
          <div className="flex flex-col py-2">
            ...
            {userData && (
              <button className="flex items-center gap-3 px-4 py-2 hover:bg-gray-700" onClick={() => navigate("/parent-dashboard")}>
                <MdSettingsSuggest className="text-xl text-blue-400" /> Parental Controls
              </button>
            )}

            {userData?.role === 'Admin' && (
              <button className="flex items-center gap-3 px-4 py-2 hover:bg-gray-700" onClick={() => navigate("/admin")}>
                <FaUserShield className="text-xl text-red-400" /> Admin Dashboard
              </button>
            )}
